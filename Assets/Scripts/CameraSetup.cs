...
public class CameraSetup : MonoBehaviour
{
    ...
    public float maxCameraOrthoSize = 4.8f;

    [Header("Max Ratio")]
    public Vector2 maxCameraRatio = new Vector2(21f, 9f);

    public float minCameraOrthoSize = 3.6f;
    ...
    {
        Gizmos.color = color;
        Gizmos.DrawLine(new Vector3(p1.x, p1.y, -8f), new Vector3(p1.x, p2.y, -8f));
        Gizmos.DrawLine(new Vector3(p1.x, p1.y, -8f), new Vector3(p2.x, p1.y, -8f));
        Gizmos.DrawLine(new Vector3(p2.x, p2.y, -8f), new Vector3(p1.x, p2.y, -8f));
        Gizmos.DrawLine(new Vector3(p2.x, p2.y, -8f), new Vector3(p2.x, p1.y, -8f));
    }
#endif
}
